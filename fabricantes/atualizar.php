...
$lerfabricante = $fabricante->lerUmFabricante();
...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            <input type="hidden" name="id" value="<?=$lerfabricante['id']?>">
            <p>
                <label for="nome">Nome:</label>
                <input value="<?=$lerfabricante['nome']?>" required type="text" name="nome" id="nome">
            </p>
